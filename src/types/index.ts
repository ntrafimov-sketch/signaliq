...
export interface Account {
  ...
  emailCollection?: { emailPattern?: string; confirmedCount?: number; missingCount?: number; contacts?: Array<{ name: string; email: string | null; title: string; hubspot_status?: string; outreach_priority?: number }> };
  jobOpenings?: Array<{ title: string; department?: string; location?: string; url?: string; posted?: string; salary?: string; relevance?: string; signal?: string }>;
  orgChart?: {
